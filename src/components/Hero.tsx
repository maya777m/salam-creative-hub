...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const geometries = [
      new THREE.IcosahedronGeometry(1, 0), // 3D pentagon shapes
    ...
    for (let i = 0; i < 15; i++) {
      ...
      const material = new THREE.MeshBasicMaterial({
        color: new THREE.Color(`hsl(${Math.random() * 45 + 35}, 100%, 75%)`), // Amber shades
        wireframe: true
      });
    ...
    <section className="relative pt-28 pb-12 md:pt-32 md:pb-16 bg-gradient-to-b from-amber-50 to-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="w-full flex justify-center mt-12">
          <div className="bg-white bg-opacity-80 backdrop-blur-sm rounded-full shadow-md py-3 px-6 md:px-10 flex flex-wrap gap-3 md:gap-6 justify-center items-center">
            <Link to="/" className="text-amber-600 hover:text-amber-800 font-medium">Home</Link>
            <Link to="/about" className="text-gray-700 hover:text-amber-600 font-medium">About</Link>
            <Link to="/services" className="text-gray-700 hover:text-amber-600 font-medium">Services</Link>
            <Link to="/portfolio" className="text-gray-700 hover:text-amber-600 font-medium">Portfolio</Link>
            <Link to="/testimonials" className="text-gray-700 hover:text-amber-600 font-medium">Testimonials</Link>
            <Link to="/contact" className="text-gray-700 hover:text-amber-600 font-medium">Contact</Link>
          </div>
        </div>
