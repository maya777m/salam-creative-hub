...
const Hero: React.FC = () => {
  ...
  const slides = [
    {
      ...
      primaryAction: { text: "View My Work", link: "/portfolio" },
    ...
    },
    {
      ...
      primaryAction: { text: "View Portfolio", link: "/portfolio" },
      secondaryAction: { text: "Start Project", link: "/contact" }
    },
    {
      id: 3,
      ...
      primaryAction: { text: "See Results", link: "/testimonials" },
      secondaryAction: { text: "Get Quote", link: "/contact" }
    }
  ];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-30 py-0">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Link 
                to={currentSlideData.primaryAction.link}
                className="bg-amber-500 hover:bg-amber-600 text-white px-8 py-4 rounded-lg font-medium transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-105 min-w-[200px]"
              >
                {currentSlideData.primaryAction.text}
                <ArrowRight size={18} className="ml-2" />
              </Link>
              <Link 
                to={currentSlideData.secondaryAction.link}
                className="border-2 border-amber-400 text-amber-400 hover:bg-amber-400 hover:text-gray-900 px-8 py-4 rounded-lg font-medium transition-all duration-300 flex items-center justify-center backdrop-blur-sm hover:backdrop-blur-md transform hover:-translate-y-1 hover:scale-105 min-w-[200px]"
              >
          ...
          <div className="flex flex-wrap gap-4 justify-center animate-fade-in max-w-4xl">
            {[
              ...
              <button 
                ...
                className="px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full text-white hover:text-amber-400 hover:bg-white/20 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1 border border-white/20 hover:border-amber-400/50" 
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce z-40">
          <div className="flex flex-col items-center">
            ...
            <button 
              ...
              className="w-8 h-8 border-2 border-amber-400 rounded-full flex items-center justify-center hover:bg-amber-400 hover:text-gray-900 transition-all duration-300"
            >
              <ChevronDown size={16} className="text-amber-400 hover:text-gray-900" />
            </button>
          </div>
        </div>
      </div>
