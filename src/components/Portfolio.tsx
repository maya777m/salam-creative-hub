          ...
          <button
            ...
            className={`px-6 py-3 rounded-full transition-all duration-300 font-medium transform hover:scale-105 ${
              activeFilter === 'all'
                ...
                : 'bg-white text-gray-700 hover:bg-amber-100 shadow-md border border-gray-200'
            }`}
          >
            All Projects
          </button>
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link 
                  ...
                  className="inline-flex items-center text-amber-500 font-medium hover:text-amber-600 transition-colors group-hover:translate-x-1 transform duration-300"
                >
