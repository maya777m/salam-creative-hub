        ...
        <div className="flex flex-col-reverse md:flex-row md:items-center md:gap-12">
          ...
          <div className="md:w-1/2 animate-slide-up">
            <div className="relative">
              <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=987&q=80" alt="Md. Abdus Salam Working" className="rounded-lg shadow-xl w-full h-100object-cover" />
