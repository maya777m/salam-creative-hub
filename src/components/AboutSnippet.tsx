...
const AboutSnippet: React.FC = () => {
  return (
    <section id="about" className="py-16 md:py-20 bg-gradient-to-br from-gray-50 via-white to-amber-50 relative overflow-hidden">
      {/* Texture Background */}
          ...
          <div className="animate-fade-in order-2 lg:order-1">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-amber-600 text-sm">5+ Years Experience</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link 
                to="/portfolio" 
                className="bg-amber-500 hover:bg-amber-600 text-white px-8 py-3 rounded-lg font-medium transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                View Portfolio <ArrowRight size={18} className="ml-2" />
              </Link>
              <Link 
                to="/contact" 
                className="border-2 border-amber-500 text-amber-500 hover:bg-amber-500 hover:text-white px-8 py-3 rounded-lg font-medium transition-all duration-300 flex items-center justify-center transform hover:-translate-y-1"
              >
                Hire Me
              </Link>
            </div>
            ...
            <div className="relative max-w-md mx-auto">
              ...
              <div className="relative bg-white p-6 rounded-2xl shadow-xl transform hover:scale-105 transition-transform duration-500">
                <img 
                  ...
                  alt="Md. Abdus Salam - Digital Marketing Expert" 
              ...
              <div className="absolute top-1/2 -right-6 w-10 h-10 bg-green-500 rounded-full flex items-center justify-center shadow-lg animate-bounce" style={{ animationDelay: '1s' }}>
                <Target size={20} className="text-white" />
              </div>
              
              <div className="absolute -bottom-2 left-8 w-8 h-8 bg-purple-500 rounded-full flex items-center justify-center shadow-lg animate-bounce" style={{ animationDelay: '2s' }}>
