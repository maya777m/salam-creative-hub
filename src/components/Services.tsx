...
const Services: React.FC = () => {
  ...
  return (
    <section id="services" className="py-16 md:py-20 bg-gradient-to-br from-white via-gray-50 to-amber-50 relative overflow-hidden">
      {/* Texture Background */}
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link 
                  to="/services" 
                  className="text-amber-500 font-medium hover:text-amber-600 transition-colors group-hover:translate-x-1 transform duration-300 inline-flex items-center"
                >
        ...
        <div className="text-center animate-fade-in">
          <Link 
            to="/services" 
            className="bg-amber-500 hover:bg-amber-600 text-white px-8 py-4 rounded-lg font-medium transition-all duration-300 inline-flex items-center shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
